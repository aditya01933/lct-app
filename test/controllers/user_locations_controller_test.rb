...
class UserLocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_location" do
    assert_difference("UserLocation.count") do
      post user_locations_url, params: { user_location: { lat: @user_location.lat, long: @user_location.long } }
    end
  ...
  test "should update user_location" do
    patch user_location_url(@user_location), params: { user_location: { lat: @user_location.lat, long: @user_location.long } }
